...
/*!****************************************!*\
  !*** ./src/app/core/services/index.ts ***!
  \****************************************/
/*! exports provided: BeneficiariesService, EstatePlanService, HelpersService, ProfileService, AccountsService, ApiService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
let AccountsListComponent = class AccountsListComponent {
    constructor(fb, accountsService) {
        this.fb = fb;
     ...
     */
    getAccounts() {
        this.accounts$ = this.accountsService.getAccounts(this.isAll).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(response => {
            this.accounts.setAccounts(response.data.assets);
     ...
     */
    buildAccounts() {
        const array = this.accounts.getAccounts().map(() => {
     ...
     */
    onCheckboxChanges(event, account) {
     ...
     * choose all accounts
     */
    chooseAllEvent(event) {
        this.accountControls.controls.map(control => {
            control.setValue(event.target.checked);
        });
        this.accounts.setCheckedAccounts(event.target.checked ? [...this.accounts.getAccounts()] : []);
    }
};
AccountsListComponent.ctorParameters = () => [
...
let SinglePageLayoutComponent = class SinglePageLayoutComponent {
    constructor(router) {
        this.router = router;
    }
    ngOnInit() {
...
SinglePageLayoutComponent.ctorParameters = () => [
...
let EstatePlanRoutingModule = class EstatePlanRoutingModule {
};
...
let EstatePlanModule = class EstatePlanModule {
};
...
let AssignBeneficiariesPageComponent = class AssignBeneficiariesPageComponent {
    constructor(router, accountsService, beneficiariesService) {
        this.router = router;
        this.accountsService = accountsService;
...
AssignBeneficiariesPageComponent.ctorParameters = () => [
...
let EstatePlanPageComponent = class EstatePlanPageComponent {
    constructor(helpers, accountsService, toasterService, router, dialog) {
    ...
    getEstatePlan() {
        this.accountsService.getAccounts(true)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["takeUntil"])(this.destroy$))
            .subscribe(response => {
            const accounts = this.convertToEstatePlanTable(response.data.assets);
            console.log(accounts);
            this.estatePlan.setAccounts(accounts);
            this.estatePlan.setEstatePlanData(response.data.isComplete, response.data.lastUpdatedDate);
            this.loading = false;
        });
    }
    /**
     ...
     */
    deleteAsset(accountId) {
        let isRemoveAccount = confirm(`Account will be removed from Estate Plan. However, this Account will still remain in your portfolio and can be added back`);
        if (!isRemoveAccount)
            return;
        this.lock = true;
        this.accountsService.removeAccount(accountId)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["takeUntil"])(this.destroy$))
            .subscribe(response => {
            this.estatePlan.setEstatePlanData(response.data.isComplete);
            this.estatePlan.removeAccount(accountId);
            this.lock = false;
            this.toasterService.showSuccess('Account has been removed from estate plan list successfully');
        });
    }
    /**
     ...
     */
    convertToEstatePlanTable(accounts) {
        return accounts.map(value => {
            const { asset_unique_id, asset_account_num, asset_group_title, asset_title, asset_url, asset_notes, beneficiaries } = value;
            return {
                asset_unique_id,
                asset_group_title,
                // image: '',
...
EstatePlanPageComponent.ctorParameters = () => [
...
let EditUserProfileComponent = class EditUserProfileComponent {
    constructor(fb, profileService, dialog) {
        this.fb = fb;
    ...
    getCountries() {
        this.profileService.getCountries()
            ...
            .subscribe(counties => {
            this.countries = counties.data;
            if (this.userProfile.user_country.id) {
                this.getStates(+this.userProfile.user_country.id, +this.userProfile.user_state.id);
                this.profileForm.get('user_country').setValue(+this.userProfile.user_country.id, { emitEvent: false });
            }
        });
    }
    /**
     ...
     */
    getStates(countryId, value) {
        this.profileService.getStates(countryId)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["takeUntil"])(this.destroy$))
            .subscribe(counties => {
            this.states = counties.data;
            this.profileForm.get('user_state').setValue(value);
        });
    }
    /**
    ...
    createProfileForm() {
        ...
        this.profileForm.get('user_country').valueChanges
            ...
            if (countryId == 1) {
                ...
                this.zipPattern = "^([A-Z][0-9][A-Z] ?[0-9][A-Z][0-9])$";
            }
            else if (countryId == 3) {
                this.zipPattern = "^[1-9][0-9]{5}$";
            }
            else if (countryId == 4) {
                this.zipPattern = "^[0-9]{4}$";
            }
            else {
                this.zipPattern = "^[a-zA-Z0-9_]*$";
            }
            this.getStates(countryId, null);
        });
    }
    /**
    ...
    saveUserProfile() {
        ...
        const fieldsForSaving = Object.assign({}, this.profileForm.value);
        fieldsForSaving.user_country = this.countries.find(country => country.id === fieldsForSaving.user_country);
        fieldsForSaving.user_state = this.states.find(state => state.id === fieldsForSaving.user_state);
...
EditUserProfileComponent.ctorParameters = () => [
...
let UserProfileBlockComponent = class UserProfileBlockComponent {
    constructor(authService, profileService, estatePlanService) {
     ...
     */
    getUserProfile() {
        this.userProfile$ = this.authService.getUserProfile().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(value => {
    ...
    saveUserProfile(userProfile) {
        this.lock = true;
        const currentUserProfile = Object.assign({}, userProfile, { estatePlanTC: userProfile.estatePlanTC ? 'YES' : 'NO' });
        this.profileService.updateUserProfile(currentUserProfile)
            ...
            console.log(this.userProfile, 'on save');
        }, () => {
            this.lock = false;
        });
    }
};
UserProfileBlockComponent.ctorParameters = () => [
...
let BeneficiariesBlockComponent = class BeneficiariesBlockComponent {
    constructor(helpers, dialog, toasterService, beneficiariesService) {
        this.helpers = helpers;
        this.dialog = dialog;
        this.toasterService = toasterService;
        this.beneficiariesService = beneficiariesService;
     ...
     */
    getBeneficiariesForAllAccounts() {
    ...
    getBeneficiaries() {
        return this.beneficiariesService
            ...
            this.beneficiaries.setBeneficiaries(value.data);
            this.amount = !!this.beneficiaries.getBeneficiaries().length;
            return value.data;
        }));
    }
    /**
     ...
     */
    changeOrder(event) {
        const currentList = this.beneficiaries.getBeneficiaries();
    ...
    saveBeneficiaries() {
        this.lock = true;
        const forSaving = { beneficiaries: [] };
        const currentBeneficiaries = this.beneficiaries.getBeneficiaries();
        currentBeneficiaries.forEach((contact, index) => {
            forSaving.beneficiaries.push({
        ...
        this.beneficiariesService.updateBeneficiariesByAccount(this.accountId, forSaving)
            ...
            .subscribe(() => {
            this.lock = false;
            this.toasterService.showSuccess('Beneficiaries has been updated');
        }, () => {
            this.lock = false;
...
BeneficiariesBlockComponent.ctorParameters = () => [
...
let SingleAssetPageComponent = class SingleAssetPageComponent {
    constructor(assetService, accountsService, passwordHintService, toasterService, route, fb, router) {
     ...
     */
    getDataForForm() {
        const getPasswordHints = this.passwordHintService.getPasswordHints();
        const getAssetGroup = this.assetService.getDrawersGroup();
        const requests = [getPasswordHints, getAssetGroup];
        if (this.assetId) {
            const getAccount = this.accountsService.getAccount(this.assetId);
            requests.push(getAccount);
        }
        this.initFormData$ = Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["forkJoin"])(requests).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(response => {
            this.passwordHints = response[0].data;
            this.drawersGroup = response[1].data;
            this.createAssetForm();
            if (response[2]) {
                this.addUserToForm(response[2].data);
            }
            return response;
        }));
    }
     ...
     */
    addUserToForm(account) {
        this.assetForm.patchValue({
            asset_title: account.title,
            asset_notes: account.notes,
            asset_group_id: this.drawersGroup.find(hint => hint.ag_id === account.asset_group_id).ag_id,
            PasswordHint_id: account.passwordHintId === 0 ? null :
                this.passwordHints.find(hint => hint.pwd_hint_id === account.passwordHintId).pwd_hint_id,
    ...
    saveAsset() {
        ...
        this.accountsService.createAccount(this.assetForm.value)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["takeUntil"])(this.destroy$))
            .subscribe(response => {
            this.router.navigate(['/estate-plan/edit/' + response.data.asset_unique_id]);
            this.toasterService.showSuccess('Account has been created');
            this.lock = false;
        }, () => {
            this.toasterService.showError('Something went wrong');
            this.lock = false;
    ...
    updateAsset() {
        ...
        this.accountsService.updateAccount(this.assetForm.value, this.assetId)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["takeUntil"])(this.destroy$))
            .subscribe(() => {
            this.toasterService.showSuccess('Account has been updated');
            this.lock = false;
        }, () => {
            this.toasterService.showSuccess('Something went wrong');
            this.lock = false;
        });
    }
};
SingleAssetPageComponent.ctorParameters = () => [
...
let AddAccountsPopupComponent = class AddAccountsPopupComponent {
    constructor(accountsService, toasterService, dialogRef) {
        this.accountsService = accountsService;
        this.toasterService = toasterService;
    ...
    addToEstatePlan() {
        this.lock = true;
        const forSaving = { accounts: [] };
        this.accounts.getCheckedAccounts().forEach((contact) => {
        ...
        this.accountsService.addAccountsToEstatePlan(forSaving)
            ...
            .subscribe(response => {
            this.lock = false;
            this.convertToEstatePlanFormat();
            console.log(response);
            this.estatePlan.setEstatePlanData(response.data.isComplete);
            this.toasterService.showSuccess('Accounts has been added to estate plan');
    ...
    */
    convertToEstatePlanFormat() {
        const accounts = this.accounts.getCheckedAccounts().map(value => {
            const { asset_unique_id, asset_account_num, asset_title, asset_group_title, asset_url, asset_notes } = value;
            return {
                asset_unique_id,
                asset_group_title,
                asset_title,
...
AddAccountsPopupComponent.ctorParameters = () => [
...
let AddBeneficiariesPopupComponent = class AddBeneficiariesPopupComponent {
    constructor(helpers, fb, dialogRef, legalService, beneficiariesService) {
        this.helpers = helpers;
        this.fb = fb;
        this.dialogRef = dialogRef;
     ...
     */
    getContacts() {
        this.contacts$ = this.legalService.getContacts().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(response => {
    ...
    buildContacts() {
        const array = this.contacts.map(contact => {
            const isCheckedItem = this.beneficiaries.getBeneficiaries()
                .filter(e => e.user_caretaker_id === contact.user_caretaker_id).length > 0;
            if (isCheckedItem) {
                this.newContacts.push(contact);
            }
            return this.fb.control(isCheckedItem);
        });
        return this.fb.array(array);
    }
    /**
     ...
     */
    onCheckboxChanges(event, contact) {
        if (!event.target.checked) {
            const contacts = this.newContacts.filter(item => item.user_caretaker_id !== contact.user_caretaker_id);
     ...
     */
    crossAmount(isCrossAmount) {
        this.contactControls.controls.map(control => {
            if (!isCrossAmount) {
                control.enable();
                return;
            }
...
AddBeneficiariesPopupComponent.ctorParameters = () => [
    { type: _core_services_helpers_service__WEBPACK_IMPORTED_MODULE_7__["HelpersService"] },
    { type: _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormBuilder"] },
    { type: _angular_material__WEBPACK_IMPORTED_MODULE_4__["MatDialogRef"] },
...
let TermsConditionsPopupComponent = class TermsConditionsPopupComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
//# sourceMappingURL=features-estate-plan-estate-plan-module-es2015.js.map